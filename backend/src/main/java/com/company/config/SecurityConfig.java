...
import com.company.security.JwtAuthorizationFilter;
import com.company.security.service.JwtService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/picture", "/api/order", "/swagger-ui/**", "/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html**", "/webjars/**")
                .permitAll()
